...
temperature = simpy.Container(env, capacity = 100.0, init = 35.0)
...
#        print seconds, minutes, hour, days
        ...
        if temperature.level > 30.5:
            print 'Pump is on'
            ser.write(temperature.level)
            power_output = ser.readline()
            
            Q += power_output*(temperature.level - room_temp)
